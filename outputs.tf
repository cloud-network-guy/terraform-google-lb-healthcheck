  ...
  value = [for i, v in local.healthchecks :
    {
      ...
      id = coalesce(
        ...
        !local.is_regional && !local.is_legacy ? google_compute_health_check.default[v.index_key].id : null,
      ...
      self_link = coalesce(
        ...
        !local.is_regional && !local.is_legacy ? google_compute_health_check.default[v.index_key].self_link : null,
